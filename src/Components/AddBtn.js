...
export default function AddBtn() {
  return (
    <Popover className="fixed bottom-10 right-10 z-10">
      ...
      <Popover.Button className="absolute bottom-0 right-0 z-10 p-2 rounded-lg font-bold text-white rounded-full inline-block border-2 border-red-600 bg-red-400">
        <svg
